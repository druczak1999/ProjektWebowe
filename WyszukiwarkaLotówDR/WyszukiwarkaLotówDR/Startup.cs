...
namespace WyszukiwarkaLotówDR
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContextPool<MyDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("MyDb2")));
            ...
            .AddOAuth("Okta", options =>
            {
                ...
                options.CallbackPath = new PathString("/LotModels/Index/admin/authorization-code/callback");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute(
                   name: "lot",
                   pattern: "{controller=LotModels}/{action=Index}/lot");

                endpoints.MapControllerRoute(
                    name: "admin",
                    pattern: "{controller=LotModels}/{action=Index}/admin");
