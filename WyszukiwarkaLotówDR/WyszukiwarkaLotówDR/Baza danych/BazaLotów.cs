...
namespace WyszukiwarkaLotówDR.Baza_danych
{
    public class BazaLotów:IBazaLotów
    {
        ...
        {
            new Lot(1,Przewoznik.LOT,DateTime.Now.AddDays(1),DateTime.Now.AddDays(4),"Wrocław","Istambuł","WRO","IST",459,150),
            new Lot(2,Przewoznik.EnterAir,DateTime.Now.AddDays(-1),DateTime.Now.AddDays(1),"Kalisz","Istambuł","WRO","IST",451,150),
            new Lot(3,Przewoznik.Ryanair,DateTime.Now.AddDays(-1),DateTime.Now.AddDays(1),"Szczecin","Barcelona","WRO","IST",452,150),
            new Lot(4,Przewoznik.Ryanair,DateTime.Now,DateTime.Now.AddDays(1),"Wrocław","Barcelona","WRO","IST",453,150),
            new Lot(5,Przewoznik.Ryanair, DateTime.Now,DateTime.Now.AddDays(1),"Kalisz","Barcelona","WRO","IST",453,150),
            new Lot(6,Przewoznik.LOT, DateTime.Now,DateTime.Now.AddDays(1),"Szczecin","Barcelona","WRO","IST",453,150)
        };
